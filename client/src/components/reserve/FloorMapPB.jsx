    ...
    <div className="flex-1 flex flex-col h-full w-full min-w-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8 relative w-full">
        ...
        >
          ...
          <SelectableRoom
            sala={findSala('Fundidora PBSJ-076')}
            name="Fundidora PBSJ-076"
          ...
          <SelectableRoom
            sala={findSala('La Huasteca PBSJ-077')}
            name="La Huasteca PBSJ-077"
          ...
          <SelectableRoom
            sala={findSala('Monterrey PBSJ-078')}
            name="Monterrey PBSJ-078"
